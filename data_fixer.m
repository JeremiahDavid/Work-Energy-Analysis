function [time_uniq, angle_uniq_time, torque_uniq, angle_uniq_torque] = data_fixer(time,angle)
...
%% Average Reapeating Angles - Time
[time_uniq,angle_uniq_time] = Averager(time,angle_cont);
