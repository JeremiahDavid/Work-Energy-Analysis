function [integration_values, angle_uniq_torque_rad] = data_fixer_work(friction,angle,torque)
...
torque_ss = mean(torque_uniq(end-200:end))
torque_uniq = torque_uniq-torque_ss;
